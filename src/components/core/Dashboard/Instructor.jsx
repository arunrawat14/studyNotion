...
const Instructor = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      console.log("instructor data is : "+ instructorApiData);
  ...
  if (instructorData === null) {
    return (
      <div>
        <p>Fetching instructor data...</p>
        {/* You can also render a loading spinner here */}
      </div>
    );
  }
  ...
  console.log("instructor data is ", instructorData)

  console.log("total Ammout is: "+ totalAmount)
  ...
  console.log("total Students is: "+ totalStudents)
                            ...
                            <div className="mt-3 w-full">
                              ...
                              <div className="mt-1 flex items-center space-x-2">
                                <p className="text-xs font-medium text-richblack-300">
                                  {course.studentEnroll.length} students
                                </p>
                                <p className="text-xs font-medium text-richblack-300">
                                  |
                                </p>
